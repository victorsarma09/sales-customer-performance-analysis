...
![PowerQuery](https://img.shields.io/badge/PowerQuery-Data%20Cleaning-yellow)
...
* Consolidated three related source datasets into a unified analytical structure
...
* Merged customer, order, and product datasets into a master analytical table
* Prepared a clean dataset for Excel reporting and PostgreSQL analysis
...
```text
Raw Customer, Order & Product Data
                ↓
...
* Created charts for trend, comparison, profitability, and customer analysis
...
* Designed an interactive slicer-based dashboard

### PostgreSQL Analysis

* Performed sales, customer, product, and profitability analysis
* Applied aggregate functions, GROUP BY, HAVING clauses, and filtering techniques
* Used Common Table Expressions (CTEs) for multi-step analysis
* Implemented window functions and ranking functions for comparative analysis
...
* Used subqueries for customer risk and recency analysis
...
![ Sales & Customer Performance Dashboard](images/dashboard1.png)
